...
> = {
  ok: {
    ...
    hint: "Por debajo de 50.000 € o sin variación >20.000 € desde la última declaración.",
  },
  new: {
    variant: "warning",
    label: "declarar (≥50k)",
    hint: "Bloque no declarado antes que supera los 50.000 € — toca presentar el modelo.",
  },
  delta_20k: {
    variant: "warning",
  ...
  return (
    <Card title="Bienes en el extranjero a 31-dic (modelos 720 · 721 · D-6)">
      <p className="px-4 pt-3 text-xs text-muted-foreground">
        ...
        Solo obligan a partir de 50.000 € por bloque.
      </p>
      {hasUnvalued ? (
        <div
          role="alert"
