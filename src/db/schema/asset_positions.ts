...
export const assetPositions = sqliteTable(
  "asset_positions",
  {
    ...
    averageCostNative: real("average_cost_native").notNull().default(0),
    totalCostNative: real("total_cost_native").notNull().default(0),
    totalCostEur: real("total_cost_eur").notNull().default(0),
